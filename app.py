...
while True:
  ...
  for each_word in list_of_words:
    ...
    if each_word == "tired":
      ...
      encouragement_list.append("you should rest well, Hope you are feelig better!")
      counter += 1
    if each_word == "sad":
  ...
  if counter == 0:
      ...
      output = "It seems that you are feeling quite " + feelings_list[0] + ". Do remember that "+ encouragement_list[0] )"  
